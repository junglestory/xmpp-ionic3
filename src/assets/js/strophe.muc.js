...
Strophe.addConnectionPlugin('muc', {
  ...
  */
  ...
  message: function(room, nick, message, html_message, type) {
    ...
    console.log("room_nick : " + room_nick);
    console.log("jid : " + this._connection.jid);
  ...
  */
  ...
  /*
  <iq from='owner-user@domain.com/nickname' id='begone' to='room-name@conference.domain.com' type='set'>
        <query xmlns='http://jabber.org/protocol/muc#owner'>
          <destroy jid='room-name@conference.domain.com'>
            <reason>This room is over.</reason>
          </destroy>
        </query>
      </iq>
      */
  ...
  */
  ...
  createInstantRoom: function(room, roomName, success_cb, error_cb) {
    var roomiq;
    roomiq = $iq({
      to: room,
      type: "set"
    ...
    roomiq.c('field', { 'var': 'muc#roomconfig_roomname' }).c('value').t(roomName).up().up();
  ...
  Parameters:
  (String) room - The multi-user chat room name.
  (String) roomName - The multi-user chat real room name.
  Returns:
  id - the unique id used to create the chat room.
  */

  createPersistentRoom: function(room, roomName, success_cb, error_cb) {
    var roomiq;
    roomiq = $iq({
      to: room,
      type: "set"
    ...
    roomiq.c('field', { 'var': 'muc#roomconfig_publicroom' }).c('value').t('1').up().up();
    roomiq.c('field', { 'var': 'muc#roomconfig_persistentroom' }).c('value').t('1').up().up();
    roomiq.c('field', { 'var': 'muc#roomconfig_roomname' }).c('value').t(roomName).up().up();
   
    return this._connection.sendIQ(roomiq.tree(), success_cb, error_cb);
  },
  setRoomName: function(room, roomName) {
  ...
  */
  ...
  countPaticipants: function(room, handle_cb, error_cb) {
...
/*
  ...
  */  
    return this._connection.send(presence);

    //return this._connection.send(presence.tree(), handle_cb, error_cb);
  },

listPaticipant: function(handle_cb, error_cb) {
    var iq = $iq({
      type: "get",
      id: this._connection.getUniqueId()
    }).c("query", {
